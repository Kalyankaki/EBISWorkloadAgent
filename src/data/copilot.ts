...
export const COPILOT_TURNS: Record<ScenarioStepId, CopilotTurn[]> = {
  steady: [
    ...
    {
      role: "assistant",
      text: "All 8 business processes are healthy. GL Period Close, O2C, P2P all in their SLOs. There are 6 open architecture drift items — 1 critical (redo storage tier) and 4 warnings. I can summarize them or open the most important one for you.",
      citations: [
        { componentId: "stg-redo", label: "Redo storage drift" },
        { componentId: "nsg-db", label: "DB NSG drift" },
      ],
    },
  ],
  early: [
    {
      ...
      citations: [
        { componentId: "stg-redo", label: "Redo storage" },
        { componentId: "odba-rac", label: "Oracle DB@Azure RAC" },
        { componentId: "cm", label: "Concurrent Manager" },
      ],
    },
  ],
  incident: [
    {
      ...
      citations: [
        { componentId: "stg-redo", label: "Storage" },
        { componentId: "odba-rac", label: "RAC" },
        { componentId: "cm", label: "Concurrent Manager" },
        { componentId: "gl-close", label: "GL Period Close" },
      ],
    },
  ],
  impact: [
    {
      ...
      citations: [
        { componentId: "gl-close", label: "GL Period Close" },
        { componentId: "stg-redo", label: "Storage SKU change" },
      ],
    },
  ],
  resolved: [
